...
test.describe('Table Data: Largest Deviation', () => {
  ...
  test('Verify table shows pollutant data for the timestamp that has the largest deviation - forecast AQI 4, measurement AQI 3', async ({
    page,
    vairifySummaryPage,
  }) => {
    const forecastLondonValidTimeArray: object[] = [
  ...
  test('Verify table shows pollutant data for the timestamp that has the largest deviation - forecast AQI 3, measurement AQI 4', async ({
    page,
    vairifySummaryPage,
  }) => {
    const forecastLondonValidTimeArray: object[] = [
