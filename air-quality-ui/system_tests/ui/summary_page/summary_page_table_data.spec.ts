...
test.describe("Table structure based on forecast window ", () => {
  test.beforeEach(async ({ page }) => {
    const forecastOptionsArray: object[] = [
      createForecastAPIResponseData({
        base_time: "2024-07-01T00:00:00Z",
        valid_time: "2024-07-01T00:00:00Z",
        location_name: "Los Angeles",
        overall_aqi_level: CaseAQI1.aqiLevel,
        no2: { aqi_level: CaseAQI1.aqiLevel, value: CaseAQI1.no2 },
      ...
      //out of max range by 1 second
      createForecastAPIResponseData({
        base_time: "2024-07-01T00:00:00Z",
        valid_time: "2024-07-06T00:00:01Z",
      ...
      createForecastAPIResponseData({
        base_time: "2024-07-01T00:00:00Z",
        valid_time: "2024-07-07T00:00:00Z",
      ...
      //lower out of bounds
      createForecastAPIResponseData({
        base_time: "2024-06-30T00:00:00Z",
        valid_time: "2024-06-30T00:00:00Z",
        location_name: "Seoul",
        overall_aqi_level: CaseAQI1.aqiLevel,
        no2: { aqi_level: CaseAQI1.aqiLevel, value: CaseAQI1.no2 },
        o3: { aqi_level: CaseAQI1.aqiLevel, value: CaseAQI1.o3 },
    ...
    const summaryOptionsArray: object[] = [
      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-01T00:00:00Z",
        location_name: "Los Angeles",
        overall_aqi_level: { mean: CaseAQI2.aqiLevel },
        no2: {
        ...
        pm10: {
          mean: { aqi_level: CaseAQI2.aqiLevel, value: CaseAQI2.pm10 },
        },
        so2: {
          mean: { aqi_level: CaseAQI2.aqiLevel, value: CaseAQI2.so2 },
        },
      }),
      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-02T00:00:00Z",
        location_name: "Kuwait City",
        overall_aqi_level: { mean: CaseAQI3.aqiLevel },
        no2: {
          mean: { aqi_level: CaseAQI3.aqiLevel, value: CaseAQI3.no2 },
      ...
      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-03T00:00:00Z",
        location_name: "Kampala",
        overall_aqi_level: { mean: CaseAQI4.aqiLevel },
        no2: {
          mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.no2 },
        },
        o3: { mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.o3 } },
        pm2_5: {
          mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.pm2_5 },
        },
        pm10: {
          mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.pm10 },
        },
        so2: {
          mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.so2 },
        },
      }),
      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-04T00:00:00Z",
        location_name: "Zurich",
        overall_aqi_level: { mean: CaseAQI5.aqiLevel },
        no2: {
          mean: { aqi_level: CaseAQI5.aqiLevel, value: CaseAQI5.no2 },
        },
        o3: { mean: { aqi_level: CaseAQI5.aqiLevel, value: CaseAQI5.o3 } },
        pm2_5: {
          mean: { aqi_level: CaseAQI5.aqiLevel, value: CaseAQI5.pm2_5 },
        },
        pm10: {
          mean: { aqi_level: CaseAQI5.aqiLevel, value: CaseAQI5.pm10 },
        },
        so2: {
          mean: { aqi_level: CaseAQI5.aqiLevel, value: CaseAQI5.so2 },
        },
      }),

      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-05T00:00:00Z",
        location_name: "Lima",
        overall_aqi_level: { mean: CaseAQI6.aqiLevel },
        no2: {
          mean: { aqi_level: CaseAQI6.aqiLevel, value: CaseAQI6.no2 },
      ...
      createMeasurementSummaryAPIResponseData({
        measurement_base_time: "2024-07-06T00:00:00Z",
        location_name: "Guadalajara",
        overall_aqi_level: { mean: CaseAQI4.aqiLevel },
        no2: {
          mean: { aqi_level: CaseAQI4.aqiLevel, value: CaseAQI4.no2 },
    ...
    await setupPageWithMockData(page, [
      {
        endpointUrl: "*/**/air-pollutant/forecast*",
        mockedAPIResponse: forecastOptionsArray,
      },
      {
        endpointUrl: "*/**/air-pollutant/measurements/summary*",
        mockedAPIResponse: summaryOptionsArray,
      },
    ]);
...
test("Verify changing date in date picker triggers change of data displayed", async ({
  ...
  await gotoPage(page, "/city/summary");
  await summaryPage.waitForLoad();
  await summaryPage.assertGridAttributes(
    "values",
    expectedInitialTableContents
  );
