...
@patch("air_quality.etl.in_situ.openaq_dao.requests")
def test__fetch_in_situ_measurements__single_city_multiple_measurements(
        requests_patch
):
    response_mock = Mock()
...
@patch("air_quality.etl.in_situ.openaq_dao.requests")
def test__fetch_in_situ_measurements__single_city_too_many_measurements(
        requests_patch
):
    response_mock = Mock()
