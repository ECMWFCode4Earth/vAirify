...
def create_test_pollutant_data(steps, latitudes, longitudes, values) -> xarray.DataArray:
    index = pd.MultiIndex.from_product([steps, latitudes, longitudes], names=['step', 'latitude', 'longitude'])
...
no2 = create_test_pollutant_data(
    ...
    values=[
        ...
        None, 0.000000125, None,  # 10
        None, None, 0.00000015,   # 350
        0.0000002, None, None,
        None, 0.000000225, None,
        None, None, 0.00000025
    ]
)
...
go3 = create_test_pollutant_data(
    ...
    values=[
        ...
        None, None, 0.00000035,
        0.0000004, None, None,
        None, 0.000000425, None,
        None, None, 0.00000045
    ]
)
...
so2 = create_test_pollutant_data(
    ...
    values=[
        ...
        None, None, 0.00000055,
        0.0000006, None, None,
        None, 0.000000625, None,
        None, None, 0.00000065
    ]
)
...
pm2p5 = create_test_pollutant_data(
    ...
    values=[
        ...
        None, None, 0.00000075,
        0.0000008, None, None,
        None, 0.000000825, None,
        None, None, 0.00000085
    ]
)
...
pm10 = create_test_pollutant_data(
    ...
    values=[
        ...
        None, None, 0.00000095,
        0.000001, None, None,
        None, 0.000001225, None,
        None, None, 0.00000125
    ]
)
