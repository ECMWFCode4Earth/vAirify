...
from src.run_in_situ_etl import main
...
@patch("src.run_in_situ_etl.insert_data")
@patch("src.run_in_situ_etl.retrieve_openaq_in_situ_data")
@patch("src.run_in_situ_etl.get_locations_by_type")
@freeze_time("2024-06-05")
def test__run_in_situ_etl__no_cities_override(mock_locations, mock_fetch, mock_insert):
    with patch("src.run_in_situ_etl.config.fileConfig"):
